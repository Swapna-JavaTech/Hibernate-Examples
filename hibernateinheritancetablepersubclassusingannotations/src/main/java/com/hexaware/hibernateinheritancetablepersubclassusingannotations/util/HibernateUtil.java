package com.hexaware.hibernateinheritancetablepersubclassusingannotations.util;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
            	...
            	cfg.addAnnotatedClass(AmazonCustomer.class);
            	cfg.addAnnotatedClass(PrimeCustomer.class);
            	cfg.addAnnotatedClass(RegularCustomer.class);
